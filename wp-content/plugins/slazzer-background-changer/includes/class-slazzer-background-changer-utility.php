...
function get_base64_image($image_id)
...
function get_request_body($arr_media_image, $old_image_file_name)

{
    ...
    if (get_option('background_option') == 'remove_background_option') {
        ...
        $postRequest = array(
            ...
            'bg_image_url' => get_option('background_image')
...
function download_image_from_url($image_url, $product_id, $old_image_file_name)

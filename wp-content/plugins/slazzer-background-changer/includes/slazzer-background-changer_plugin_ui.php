...
<div class="slazzer-options widefat">
    <img src="<?php echo SLAZZER_ROOT_URL.'icon-256x256.png';?>" style="height:35px;">
        ...
        <table class="wp-list-table widefat fixed striped">
            ...
            <tr valign="top">
                ...
                <td>
                    <input type="text" name="slazzer_live_api_key" id="slazzer_live_api_key" class="slazzer_input"
                           value="<?php if ($slazzer_live_key) echo $slazzer_live_key; ?>"
                    ...
                    <p class="remaining_credits">
                        ...
                        ?>
                        <span id="remaining_credits" <?php echo $api_text_class; ?>>
                            <?php
            ...
            <tr valign="top">
                ...
                <td>
                    ...
                    <input type="text"
                           class="slazzer_input text-full-width" <?php if ($slazzer_products == 'specified') echo 'style="display: block;"'; else echo 'style="display: none;"'; ?>
                           placeholder="4,156,271" id="Slazzer_products_IDs" name="Slazzer_products_IDs"
                           value="<?php if ($Slazzer_products_IDs) echo $Slazzer_products_IDs; ?>">
            ...
            <tr valign="top">
                ...
                <td>
                    ...
                    ?>        
                    <div class="slazzer_gallery_image_ids <?php echo $hide_class; ?>">        
                        <input type="text" name="Slazzer_Product_Gallery_Image_Ids" id="Slazzer_Product_Gallery_Image_Ids" value="<?php echo $Slazzer_gallery_image_IDs; ?>" class="slazzer_input text-full-width" >
                        <br/>
                ...
                <td>
                    ...
                    <p id="background_color_p" <?php if ($background_option == 'background_color_option') echo 'style="display:block;"'; else echo 'style="display:none;"'; ?>>
                        <input type="color" class="slazzer_input" name="background_color"
                               id="background_color" <?php if ($background_color) echo 'value="' . $background_color . '"'; ?>>

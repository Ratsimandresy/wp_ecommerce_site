...

{
    ...
    $sql = "SELECT * FROM `".$wpdb->prefix."wc_slazzer_process_history` WHERE can_restore_or_delete = 1";
    ...
    $sql = "DELETE FROM `".$wpdb->prefix."wc_slazzer_process_history` WHERE can_restore_or_delete = 1";

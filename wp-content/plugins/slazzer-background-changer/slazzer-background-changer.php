 ...
 */
define( 'SLAZZER_BACKGROUND_CHANGER_VERSION', '3.5' );
 ...
 */
function activate_slazzer_background_changer() {
 ...
 */
function deactivate_slazzer_background_changer() {
...
register_activation_hook( __FILE__, 'activate_slazzer_background_changer' );
register_deactivation_hook( __FILE__, 'deactivate_slazzer_background_changer' );
 ...
 * @since    1.0.0
 */
function run_slazzer_background_changer() {

	$plugin = new Slazzer_Background_Changer();
	$plugin->run();

}
run_slazzer_background_changer();
